...
export default function ImageWithZoom({ 
  ...
  return (
    <div className={cn("flex gap-4", className)}>
      <div 
        className="relative flex-1 overflow-hidden rounded-md border md:cursor-crosshair"
      ...
      {isHovered && showZoomOnHover && (
        <div className="relative w-[400px] h-[400px] border rounded-md overflow-hidden bg-white hidden md:block">
          <Image
            src={src}
            fill
            alt={`${alt} - magnified`}
